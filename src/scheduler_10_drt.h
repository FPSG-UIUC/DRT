#ifndef SCHEDULER_10_DRT_H
#define SCHEDULER_10_DRT_H
...
#define MAX_TIME 40000000000
class Scheduler_10_drt{

	public:
		/* CONSTRUCTOR AND DESTRUCTOR*/
		// constructor -> intializer of the scheduler
		Scheduler_10_drt(Matrix * mtx, Parameters * params, Stats * stats, LLB_Mem * llb);
	...
	private:
		...
		void ExtractABasicTiles(int i_start_middle, int j_start_top, int j_end_top,
