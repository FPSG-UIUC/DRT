#ifndef SCHEDULER_6_H
#define SCHEDULER_6_H
...
class Scheduler_6{
	...
	public:
		Scheduler_6(Matrix * mtx, Parameters * params, Stats * stats, LLB_Mem * llb);
		~Scheduler_6();
		void Run();
		void PrintBWUsage();
		void PrintBWLog();
	...
	private:
		...
		// Kepps the constant a_reuse value
		int a_reuse_const;

		uint64_t * sum_i, *sum_j;
