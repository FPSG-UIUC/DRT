...
int main(int argc, char *argv[])
{
	...
	// Enable OuterSpace related initialization in matrix.cpp
	params->SetMatRaptorSim();
	printf("Toluwa, I'm here\n");
	...
	printf("Toluwa, I'm setting up the matrix\n");
	Matrix * mat = new Matrix(ip->p_input1, params, stats, llb);
	printf("Toluwa, I'm done matrix stuff\n");
	Scheduler_10 * sched_10 = new Scheduler_10(mat, params, stats, llb);
	sched_10->Run();
