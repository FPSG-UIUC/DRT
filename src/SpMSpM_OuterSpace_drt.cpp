...
int main(int argc, char *argv[])
{
	...
	Scheduler_9_drt * sched_9_drt = new Scheduler_9_drt(mat, params, stats, llb);
	sched_9_drt->Run();
...
void initializeInputParameters(input_parameters_st *input_params){
	...
	input_params->p_kernel = kernel::SpMSpM; input_params->p_a_format = CSX::COO;
	input_params->p_b_format = CSX::COO; input_params->p_o_format = CSX::COO; input_params->p_dense_cols=1;
