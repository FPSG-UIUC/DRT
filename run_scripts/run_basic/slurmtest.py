    ...
    for constreuse in [128]:
        ...
        for dataset in matrix_paths:
            if dataset.endswith(".mtx"):
                ...
                test_folder = TEST_LOG_DIR + "/res_tactile_asquared_reg_"+graph+"_cfi_rr_"+\
                                             abo_string + "_reg" + str(constreuse)
                cmd += " > " + test_folder + "/res_tactile_asquared_reg_"+graph+"_cfi_rr_"+\
                                             abo_string + "_reg" + str(constreuse) + ".txt;"
                #print(cmd)
