...
for abo_perc in [ [0.33,0.33,0.33] ]:
    for tiledim in [2, 4, 8, 16, 64, 128, 256, 512]:
        ...
        for dataset in matrix_paths:
            if dataset.endswith(".mtx"):
                ...
                cmd += " > " + test_folder + "/res_tactile_asquared_mt_sweep_"+graph+"_cfi_rr_"+\
...
sbatch_cmd = "sbatch -c 5 --mem=250G --wait ./slurmchunk.py"
