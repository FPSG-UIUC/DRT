...
for abo_perc in [ [0.01, 0.3, 0.69] ]:
    for constreuse in [1, 8, 32, 64, 128, 256, 512]:
        ...
        for dataset in matrix_paths:
            if dataset.endswith(".mtx"):
                ...
                test_folder = TEST_LOG_DIR + "/res_tactile_asquared_constreuse_"+graph+"_cfi_rr_"+\
                                             abo_string + "_constreuse" + str(constreuse)
                cmd += " > " + test_folder + "/res_tactile_asquared_constreuse_"+graph+"_cfi_rr_"+\
                                             abo_string + "_constreuse" + str(constreuse) + ".txt;"
                #print(cmd)
